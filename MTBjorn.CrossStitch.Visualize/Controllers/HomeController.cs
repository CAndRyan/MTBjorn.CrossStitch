...
namespace MTBjorn.CrossStitch.Visualize.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var diagnosticsFilePath = @"D:\Chris\Projects\MTBjorn.CrossStitch\MTBjorn.CrossStitch.Business.Test\Resources\contrast-test\contrast-test-image-3colors-weighted-reduction-diagnostics.json"; // @"D:\Chris\Downloads\cross-stitch-test-diagnostics_1.json"; // @"D:\Chris\Downloads\cross-stitch-test-diagnostics.json";
